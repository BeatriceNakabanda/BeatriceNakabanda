...
I'm Beatrice Nakabanda, a Data Scientist and Software Engineer passionate about building intelligent systems that solve real-world problems.

With 5+ years of experience in software engineering (FinTech), I bring a strong engineering mindset to data science, focusing on building practical machine learning and AI applications that can be deployed and used by real people.
...
**Live Demo**: [AI interviewer](https://interview-tool-z.streamlit.app/)
**Code**: [Github repo](https://github.com/BeatriceNakabanda/interview-tool)

### 📉 Customer Churn Prediction
Machine learning model that predicts telecom customer churn and allows users to test predictions through an interactive Streamlit app.
...
I am always interested in collaborating on Data Science, Machine Learning, and AI projects.
